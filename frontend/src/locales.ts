...
export const translations = {
  ...
  "zh-Hans": {
    ...
    failedLoadFlowDetails: "无法加载流程详情。",
    failedLoadFlows: "无法加载流程列表。",
    failedCreateFlow: "无法创建流程。",
    failedDuplicateFlow: "无法复制流程。",
    failedSaveSessionFlow: "无法将课堂保存为流程。",
    failedReorderSteps: "无法调整步骤顺序。",
    failedDeleteStep: "无法删除步骤。",
    failedLaunchActivity: "无法推送活动。",
    defaultLessonFlow: "新教学流程",
    copiedFlowPrefix: "副本：",
    defaultClassroomFlow: "课堂流程",
